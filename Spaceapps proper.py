...
def Schedule():
    ...
    blue_label=Label(Schedule,text="-SLEEP").place(x=35,y=650)   
    im22=Image.open('yellow.png')
    im23=im22.resize((20,20))
    im24=ImageTk.PhotoImage(im23)
    Key_yellow=Label(Schedule,image=im24).place(x=100,y=650)
    yellow_label=Label(Schedule,text='-EXERCISE').place(x=120,y=650)
    Key_blue=Label(Schedule,image=im21).place(x=10,y=650)
    while(count<=6):
